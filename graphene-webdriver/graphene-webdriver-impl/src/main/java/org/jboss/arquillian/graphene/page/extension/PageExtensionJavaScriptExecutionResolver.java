 ...
 */
public class PageExtensionJavaScriptExecutionResolver implements ExecutionResolver {

    private static final String FUNCTION;

    private static final String CALL = "return invokeInterface({0}, \"{1}\", arguments);";
